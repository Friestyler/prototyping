        ...
        <div className="inline-flex items-center rounded-lg border border-b2 bg-white p-0.5">
          <button
            ...
            className={cn(
              ...
              listView === "cards" ? "bg-brand text-white" : "text-muted-foreground hover:text-foreground"
            )}
          >
          ...
          <button
            ...
            className={cn(
              "inline-flex items-center gap-1.5 rounded-md py-1.5 px-3 text-[12.5px] font-medium transition-colors",
              listView === "list" ? "bg-brand text-white" : "text-muted-foreground hover:text-foreground"
            )}
          >
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-8 w-8 text-muted-foreground opacity-0 pointer-events-none"
                  aria-hidden
                >
                  <X className="h-4 w-4" />
                </Button>
              ...
              paginated.map((l, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="text-muted-foreground">{l.email || <MutedDash />}</TableCell>
