  ...
  return (
    <div className="max-w-[680px] mx-auto">
      ...
      <div className="mb-5">
        ...
        {locked && (
          <div className="flex items-center gap-2 mb-2.5 px-3 py-2 rounded-lg bg-gray-50 border border-b2 text-[12.5px] text-muted-foreground">
        ...
        >
          {[
            ...
            >
              ...
              <p className="text-xs text-muted-foreground pl-6 leading-relaxed">{desc}</p>
            </button>
          ))}
        </div>
      </div>
