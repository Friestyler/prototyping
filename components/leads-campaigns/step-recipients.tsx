          ...
          <Tabs value={activeListTab} onValueChange={setActiveListTab}>
            ...
            {tabConfig.map((t) => (
              <TabsContent key={t.key} value={t.key} className="mt-4">
                ...
                {t.lists.length === 0 ? (
                  <div className="py-6 text-center text-[13px] text-muted-foreground border border-dashed border-b2 rounded-lg">
                    ...
                    {t.lists.map((list) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-xs text-muted-foreground mt-1.5">{list.count} leads</div>
                        </button>
                      );
                    })}
                  </div>
            ...
            <TabsContent value="selected" className="mt-4">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          active
                            ...
                            : "bg-white text-muted-foreground border-b2 hover:bg-gray-50"
                        )}
                      >
                        {p.key === "Has Email" && (
              ...
              {filteredSelected.length === 0 ? (
                <div className="py-12 text-center text-[13px] text-muted-foreground border border-dashed border-b2 rounded-lg">
